...
const geminiApiBaseUrl = process.env.GEMINI_API_BASE_URL || 'https://trial.kewong.workers.dev'
const geminiUploadProxyUrl = process.env.GEMINI_UPLOAD_BASE_URL || 'https://trial.kewong.workers.dev'
